...
> 状态：Phase 0–5a + LangGraph 对齐 + 前端 Dense Comic Workbench redesign **已完成**  
...
| 3 | Skill schema + catalog API 驱动编排入口 | ✅ |
| 4 | 拉片复刻 v0（文本 brief 18 维 + 槽位替换） | ✅ |
| 5a | 九宫格分镜 + 单格重做 | ✅ |
...
- Skills：`app/skills/catalog.py` → `/api/v1/skills`
