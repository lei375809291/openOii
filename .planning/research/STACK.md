...
**Project:** openOii — AI-Agent Comic-Drama Generation Platform
**Researched:** 2026-04-11
**Confidence:** HIGH for core choices, MEDIUM for emerging agent-runtime patterns
...
uv add langgraph arq structlog opentelemetry-distro opentelemetry-exporter-otlp \
       prometheus-fastapi-instrumentator sentry-sdk alembic

# LangGraph persistence (production)
uv add langgraph-checkpoint-postgres

# Backend — LLM evaluation (dev)
uv add --dev promptfoo

# Backend — upgrade existing
uv add "fastapi[standard]>=0.128" "anthropic>=0.55" "pillow>=11.0"

# Frontend — upgrade React + Tailwind
cd frontend
pnpm add react@^19 react-dom@^19
pnpm add -D tailwindcss@^4 @tailwindcss/vite daisyui@^5
